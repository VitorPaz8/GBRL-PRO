...
import com.userservice.userservice.application.domain.exceptions.InvalidCredentialsException;
import com.userservice.userservice.application.domain.exceptions.ProductNotFoundException;
...
public class GlobalHandlerException {
	...
	public ResponseEntity<ErrorResponse> handleUserNotFound(ProductNotFoundException ex, HttpServletRequest req) {
